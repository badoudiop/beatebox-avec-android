...
export class PromptDjMidi extends LitElement {
  // Fix: Changed static styles to a class field to avoid issues with decorators.
  static styles = css`
    :host {
      height: 100%;
      display: flex;
    ...
    return html`<div id="background" style=${bg}></div>
      <div id="buttons">
        <button
          ...
          >${this.isRecording ? 'Stop' : 'Record'}</button>
        <button
...
// Fix: Add HTMLElementTagNameMap definition for this component
declare global {
